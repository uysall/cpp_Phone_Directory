...
// #define CONFIGURE_ARGS " '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/home/omer/CLionProjects/cppPhoneDirectory/cmake-build-debug/vcpkg_installed/x64-linux' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=/usr/bin/cc' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/home/omer/CLionProjects/cppPhoneDirectory/cmake-build-debug/vcpkg_installed/x64-linux/lib' 'CPPFLAGS=-DNDEBUG' 'CXX=/usr/bin/c++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/bin/pkg-config' 'PKG_CONFIG_PATH=/home/omer/.vcpkg-clion/vcpkg/packages/libpq_x64-linux/lib/pkgconfig:/home/omer/.vcpkg-clion/vcpkg/packages/libpq_x64-linux/share/pkgconfig:/home/omer/CLionProjects/cppPhoneDirectory/cmake-build-debug/vcpkg_installed/x64-linux/lib/pkgconfig:/home/omer/CLionProjects/cppPhoneDirectory/cmake-build-debug/vcpkg_installed/x64-linux/share/pkgconfig'"
